	...
	public static class HtmlUtils
	{
		...
		private static string antiXss_GetSafeHtmlFragment(string dirtyHtml)
		{
			...
			catch (Exception e)
			{
				...
				return "This document's contents have been flagged by WyzAnt's security systems as possibly containing malicious code. The contents have therefore been removed. If you feel you are receving this message in error please contact WyzAnt Customer Support by phone or email.";
			}
		}
	}
